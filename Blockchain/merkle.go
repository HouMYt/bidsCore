package Blockchain // Copyright (c) 2013-2014 The btcsuite developers
import (
	"math"
)

type MerkleTree []*ShaHash
...
// will be nil.
func BuildMerkleTreeStore(transactions []Tx) MerkleTree {
...
func (merkles MerkleTree)Root()ShaHash  {
